...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$item->personal_id}}">
  Restore
</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-success" href={{route('client.restore.action',['selectedID'=>$item->personal_id])}} >Restore</a>
      </div>
    </div>
  </div>
</div>
