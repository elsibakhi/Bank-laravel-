...
@php
    session(['page' =>route('client.deposit.page',[Auth::user()->personal_id])]);
    session(['nav_active' =>"deposit"]);
@endphp
<div class="wrapper wrapper--w680  p-t-100">
    ...
    <div class="card card-4 p-5">
        <div class="card-body">
            ...
            <form method="post" action='{{route('client.deposit')}}'>
                   @csrf
                ...
                <div class="p-t-15 justify-content-around w-100 d-flex">
                    ...
                    <button class="btn btn--radius-2 btn--blue" type="submit">Deposit Now</button>
                </div>
